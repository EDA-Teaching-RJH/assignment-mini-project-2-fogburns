...
- initial_q(): used as a confirmation before the script begins, includes cowsay to make beggining look more interesting
...
- line(390): uses an if statement to tell whether the code is being imported. If it is it wont run, This will stop any errors if the script is imported

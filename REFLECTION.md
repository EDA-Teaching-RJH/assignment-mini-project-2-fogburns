...
- line(390): Uses an if statement to tell whether the code is being imported. If it is it wont run, This will stop any errors if the script is imported.(Workshop/Lecture 7)
